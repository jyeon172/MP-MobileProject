...
class Board2Activity: ToolbarBase() {

    private lateinit var binding: Board2MainBinding
    lateinit var bind: ItemMainBinding
    lateinit var big: ActivityMainBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        binding = Board2MainBinding.inflate(layoutInflater)
        ...
        //Board3 툴바 설정
        val toolbar: Toolbar = findViewById(R.id.board2_toolbar)
    ...
    private fun makeRecyclerView(){
        ...
        MyApplication.db.collection("board2")
            ...
            .addOnSuccessListener { result ->
                ...
                binding.main2RecyclerView.layoutManager= LinearLayoutManager(this)
                binding.main2RecyclerView.adapter= My2Adapter(this, itemList)
            }
    ...
    private fun makeRecyclerMenu(option:String){
        MyApplication.db.collection("board2")
            ...
            .addOnSuccessListener { result ->
                ...
                binding.main2RecyclerView.layoutManager= LinearLayoutManager(this)
                binding.main2RecyclerView.adapter= My2Adapter(this, itemSort)
            }
            .addOnFailureListener { exception ->
                Log.d("kkang", "Error getting documents: ", exception)
                Toast.makeText(this, "서버로부터 데이터 획득에 실패했습니다.", Toast.LENGTH_SHORT).show()
