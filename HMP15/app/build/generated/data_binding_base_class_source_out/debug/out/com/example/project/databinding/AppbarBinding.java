...
public final class AppbarBinding implements ViewBinding {
  ...
  private AppbarBinding(@NonNull LinearLayout rootView, @NonNull FrameLayout activityContent,
  ...
  public static AppbarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new AppbarBinding((LinearLayout) rootView, activityContent, toolbar);
    }
